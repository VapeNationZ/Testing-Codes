...
<head>
    ...
    <meta name="keywords" content="DTOXD Start-up and products" />
    <meta name="description" content="DTOXD Start-up and product page">
    <meta name="author" content="codevelopers">
...
<body class="text-content" data-spy="scroll" data-target=".navbar-inverse" data-offset="65">
            ...
            <nav class="s-header__nav js__scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="list-unstyled s-header__nav-menu">
                        ...
                        <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider" href="#video-section">About DTOXD</a></li>
                        <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider" href="#problem">Problem</a></li>
                        <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider" href="#statistics">Statistics</a></li>
                        <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider" href="#concepts">Concepts</a></li>
                        <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider" href="#subscribe">Subscription</a></li>
                        <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider" href="#connect-with-us">Connect with us</a></li>
                    </ul>
                    <!-- End Menu List -->

                    <!-- Menu List -->
                    <ul class="list-unstyled s-header__nav-menu">
                        <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider" href="#next-release">Next Release</a></li>
                        <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider" href="#contact-us">Contact us</a></li>
                        <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider" href="#locate-us">Locate us</a></li>
            ...
            <div class="home-cover bg-parallax wow animated fadeIn">
                <div class="home-content-box">
                    ...
                    <div class="home-content-box-inner">
                        <!--isko diplay=table-cell-->
                        <div class="home-heading text-heading-white">
                            <h3 class="text-heading wow animated zoomIn" data-wow-duration="2s" data-wow-delay="1s">We aim at<br />building efficient softwares.</h3>
                        </div>
                        <!--home-heading-->
            ...
            <div class="col-md-8">
                <div id="video-section">
                    <div class="video-header">
                        <h2 style="color: #13b1cd; text-align: center">About DTOXD</h2>
                        <p style="text-align: center">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Obcaecati minus accusamus cum non aperiam fugiat hic, amet, ratione maxime, ab quasi fugit. Adipisci laborum necessitatibus deleniti in vitae at dicta.Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto tempore quo, laudantium maxime id, sed consequatur nemo cumque, labore cum dolorum? Neque, nihil! Eligendi suscipit ipsa, laboriosam iste quaerat fugiat.</p>
                    </div>
                    <div class="embed-responsive embed-responsive-16by9">
                        <video width="320" height="240" controls>
                            <source src="img/videos/DTOXD.mp4" type="video/mp4">
    ...
    <!-- Parallax -->
    <div id="problem" class="js__parallax-window" style="background: url(img/1920x1080/03.jpg) 50% 0 no-repeat fixed;">
        <div class="container g-text-center--xs g-padding-y-80--xs g-padding-y-125--sm">
            <div class="g-margin-b-80--xs">
                <h2 class="g-font-size-40--xs g-font-size-50--sm g-font-size-60--md g-color--white">Problem</h2>
            </div>
    ...
    <div class="g-promo-section">
        ...
        <div class="col-sm-3 g-promo-section__img-left--lg g-bg-position--center g-height-100-percent--md js__fullwidth-img">
            <img class="img-responsive" src="img/970x970/03.jpg" alt="Image">
        </div>
    </div>
    <!-- End Culture -->
    <!-- Parallax -->
    <div id="statistics" class="js__parallax-window" style="background: url(img/1920x1080/03.jpg) 50% 0 no-repeat fixed;">
        <div class="container g-text-center--xs g-padding-y-80--xs g-padding-y-125--sm">
            <div class="g-margin-b-80--xs">
                <h2 class="g-font-size-40--xs g-font-size-50--sm g-font-size-60--md g-color--white">Statistics</h2>
            </div>
    ...
    <!-- End Culture -->
    <!-- Parallax -->
    <div id="concepts" class="js__parallax-window" style="background: url(img/1920x1080/03.jpg) 50% 0 no-repeat fixed;">
        <div class="container g-text-center--xs g-padding-y-80--xs g-padding-y-125--sm">
            <div class="g-margin-b-80--xs">
                <h2 class="g-font-size-40--xs g-font-size-50--sm g-font-size-60--md g-color--white">Concepts</h2>
            </div>
    ...
    <div class="container g-padding-y-80--xs g-padding-y-125--sm">
        <div class="g-text-center--xs g-margin-b-80--xs">
            ...
            <h2 class="g-font-size-32--xs g-font-size-36--md">Concepts</h2>
        </div>
        <div class="row">
    ...
    <!-- Subscribe -->
    <div id="subscribe" class="js__parallax-window" style="background: url(img/1920x1080/07.jpg) 50% 0 no-repeat fixed;">
        <div class="g-container--sm g-text-center--xs g-padding-y-80--xs g-padding-y-125--sm">
            <div class="g-margin-b-80--xs">
                ...
                <h2 class="g-font-size-32--xs g-font-size-36--md g-color--white">Confirm Email</h2>
                <h3>Enter your username and the password send to you via Email</h3>
            </div>
            <div class="row">
...
<?php
	...
	//Checking is user existing in the database or not
        ...
        if($rows==1){
			...
			if($result){
            echo "<div class='form'><h3>You have successfully confirmed your Email.</h3><br/>Click here to <a href='index4.php'>login</a></div>";
        }
            }else{
				echo "<div class='form'><br/>Click here to <a href='index2.php'>Login/Register</a></div>";
				}    }else{
?>
<div class="form">
...
<?php } ?>
    ...
    <div id="connect-with-us" class="g-promo-section">
        <div class="container g-padding-y-80--xs g-padding-y-125--sm">
            <div class="row">
                ...
                <div class="col-sm-4 col-sm-offset-1">
                    ...
                    <div class="social-ic" style="color: teal">
                ...
                <div class="col-sm-6">
                    <!-- News -->
                    <article>
                        <a class="twitter-timeline" href="https://twitter.com/TwitterDev?ref_src=twsrc%5Etfw" data-width="900" data-height="300" data-chrome="nofooter noborders noscrollbar">Tweets by DTOXD</a>
        ...
        <!--div class="col-md-8 g-promo-section__img-right--lg g-bg-position--center g-height-100-percent--md">
            <a class="twitter-timeline" href="https://twitter.com/TwitterDev?ref_src=twsrc%5Etfw" data-width="300" data-height="300">Tweets by TwitterDev</a>
            <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
        </div-->
    </div>
    <!-- End News -->
    ...
    <!-- Counter -->
    <div id="next-release" class="js__parallax-window" style="background: url(img/1920x1080/06.jpg) 50% 0 no-repeat fixed;">
        <div class="container g-padding-y-80--xs g-padding-y-125--sm">
            <div class="row">
                <div class="maint">
                    <!---<h2 class="g-font-size-22--xs--xs g-color--white" style="display:inline-block;">New Release Scheduled On:</h2>--->
                    <div class="containert">
                        <h1 id="headt">Next Release Scheduled On:</h1>
                        <ul>
                            <li class="lit"><span class="spant" id="days"></span>days</li>
                            <li class="lit"><span class="spant" id="hours"></span>Hours</li>
                            <li class="lit"><span class="spant" id="minutes"></span>Minutes</li>
                            <li class="lit"><span class="spant" id="seconds"></span>Seconds</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <!-- End Counter -->
        <!-- Feedback Form -->
        <div id="contact-us" class="g-bg-color--sky-light">
            <div class="container g-padding-y-80--xs g-padding-y-125--sm">
                <div class="g-text-center--xs g-margin-b-80--xs">
        ...
        <!-- Google Map -->
        <section id="locate-us" class="s-google-map">
                ...
                <div class="container g-padding-y-80--xs">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-md-offset-2 col-sm-5 col-sm-offset-1 s-footer__logo g-padding-y-50--xs g-padding-y-0--md">
                            <h3 class="g-font-size-18--xs g-color--white">Team name</h3>
                            <p class="g-color--white-opacity">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sit labore atque, enim modi placeat! Perferendis placeat cupiditate corporis aliquid, eius tempora! Qui neque, quo at. Fugit, distinctio dolore? Modi, debitis.</p>
                        </div>
                    </div>
                </div>
            </div>
